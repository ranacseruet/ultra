...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Universal Language Translator - ULTraChat</title>
        <meta name="description" content="A next generation web application that allows you communication with anyone in the world, speaking any language, in real time">
    ...
    <body ng-app="home">
        ...
        <div id="home">
			<div class="row">
				<div class="col-md-6">
					<h1>Universal Language Translated Voice/Text Chat</h1>
					<p>
						Break the language barrier!<br>
						Voice/Text chat with anyone around the world, <br>
						speaking any(well almost) language! <br>
						No need for costly and time consuming bilingual assistance!<br>
						Communicate via instant text/voice messaging!
					</p>
					<br>
					<p class="text-center">
						<a class="btn btn-success btn-lg" href="demo.html" target="_blank">Try It Now!</a>
					</p>
				</div>
				<div class="col-md-6">
			...
			<hr>
				...
				<div share class="text-center"></div>
			<hr>
				<h3 class="text-center">Proudly Built With:</h3>
				<div class="text-center">
					<img class="api-img grey" src="img/socketio.png" width="200">
					<img class="api-img grey" src="img/yandex.png" width="200">
					<img class="api-img grey" src="img/spech.png" width="200">
				</div>
			<hr>
        ...
        <div id="about" class="margin-top">
			<div class="row">
				<div class="col-md-12">
					...
					<p>
						ULTraChat is developed as part of <a href="https://koding.com/Hackathon">koding.com hackathon, 2014</a> and became one of the
						top 100 finalist projects, among around 2000 accepted teams! The Theme was 'Challenges associated with real time communication and translation'
						and we think this project nailed it! What do you think?
					</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="description">
						<ul>
							...
							again and again.</li>
							<li>Currently the chat system is powered by a very basic implementation of <a href="https://www.socket.io">Socket.IO</a>, which might be buggy! Please contact to given email below with
                            bug reports/suggestions.</li>
